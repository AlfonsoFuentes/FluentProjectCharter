...
namespace Web.Infrastructure.Validators.PurchaseOrders
{
    public class ApprovePurchaseOrderValidator : AbstractValidator<ApprovePurchaseOrderRequest>
    {
        ...
        public ApprovePurchaseOrderValidator(IGenericService _Service)
        {
            Service = _Service;
        ...
        async Task<bool> ReviewNameExist(ApprovePurchaseOrderRequest request, string name, CancellationToken cancellationToken)
        {
        ...
        async Task<bool> ReviewPRExist(ApprovePurchaseOrderRequest request, string pr, CancellationToken cancellationToken)
        {
        ...
        async Task<bool> ReviewPOExist(ApprovePurchaseOrderRequest request, string pr, CancellationToken cancellationToken)
        {
