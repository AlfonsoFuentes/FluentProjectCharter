...
{
    public class CreateSalaryPurchaseOrderValidator : AbstractValidator<CreateSalaryPurchaseOrderRequest>
    {
        private readonly IGenericService Service;
        public CreateSalaryPurchaseOrderValidator(IGenericService _Service)
        {
            Service = _Service;
        ...
        async Task<bool> ReviewPOExist(CreateSalaryPurchaseOrderRequest request, string pr, CancellationToken cancellationToken)
        {
