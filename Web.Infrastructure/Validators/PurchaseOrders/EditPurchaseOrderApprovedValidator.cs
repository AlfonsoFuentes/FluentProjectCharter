...
{
    public class EditPurchaseOrderApprovedValidator : AbstractValidator<EditPurchaseApprovedOrderRequest>
    {
        private readonly IGenericService Service;
        public EditPurchaseOrderApprovedValidator(IGenericService _Service)
        {
            Service = _Service;
        ...
        async Task<bool> ReviewNameExist(EditPurchaseApprovedOrderRequest request, string name, CancellationToken cancellationToken)
        {
        ...
        async Task<bool> ReviewPRExist(EditPurchaseApprovedOrderRequest request, string pr, CancellationToken cancellationToken)
        {
        ...
        async Task<bool> ReviewPOExist(EditPurchaseApprovedOrderRequest request, string pr, CancellationToken cancellationToken)
        {
