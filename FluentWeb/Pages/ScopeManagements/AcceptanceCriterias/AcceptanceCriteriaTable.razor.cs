...
#nullable disable
public partial class AcceptanceCriteriaTable
{
    [Parameter]
    ...
    Func<AcceptanceCriteriaResponse, bool> fiterexpresion => x =>
    ...
    AcceptanceCriteriaResponse EditRow = null!;
    ...
    bool DisableSaveButton(AcceptanceCriteriaResponse model)
    {
    ...
    private void HandleRowClick(FluentDataGridRow<AcceptanceCriteriaResponse> row)
    {
    ...
    private void HandleRowDoubleClick(FluentDataGridRow<AcceptanceCriteriaResponse> row)
    {
    ...
    async Task Update(AcceptanceCriteriaResponse model)
    {
