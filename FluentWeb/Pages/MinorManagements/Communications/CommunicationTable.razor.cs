...
namespace FluentWeb.Pages.MinorManagements.Communications;
#nullable disable
public partial class CommunicationTable
{
    ...
    Func<CommunicationResponse, bool> fiterexpresion => x =>
       x.Name.Contains(nameFilter, StringComparison.CurrentCultureIgnoreCase);
    public List<CommunicationResponse> FilteredItems => Items.Count == 0 ? new() : Items.Where(fiterexpresion).ToList();

    CommunicationResponse CreateRow = null!;
    CommunicationResponse EditRow = null!;
    ...
    bool DisableSaveButton(CommunicationResponse model)
    {
    ...
    public async Task Create()
    {
        ...
        CreateCommunicationRequest create = CreateRow.ToCreate(StartId, PlanningId);
    ...
    private void HandleRowClick(FluentDataGridRow<CommunicationResponse> row)
    {
    ...
    private void HandleRowDoubleClick(FluentDataGridRow<CommunicationResponse> row)
    {
    ...
    async Task Update(CommunicationResponse model)
    {
