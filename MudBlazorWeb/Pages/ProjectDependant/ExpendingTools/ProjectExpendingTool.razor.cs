...
{
    ExpendingToolResponseList Response { get; set; } = new();
    [Parameter]
    ...
    async Task GetAll()
    {
        ...
        var result = await GenericService.GetAll<ExpendingToolResponseList, GetAllExpendingTool>(new GetAllExpendingTool
        {
