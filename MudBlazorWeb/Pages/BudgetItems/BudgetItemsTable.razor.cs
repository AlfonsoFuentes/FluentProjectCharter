using MudBlazor;
using MudBlazorWeb.Pages.BudgetItems.Alterations;
using MudBlazorWeb.Pages.BudgetItems.EHSs;
using MudBlazorWeb.Pages.BudgetItems.Electricals;
using MudBlazorWeb.Pages.BudgetItems.EngineeringDesigns;
using MudBlazorWeb.Pages.BudgetItems.Equipments;
using MudBlazorWeb.Pages.BudgetItems.Foundations;
using MudBlazorWeb.Pages.BudgetItems.Instruments;
using MudBlazorWeb.Pages.BudgetItems.Paintings;
using MudBlazorWeb.Pages.BudgetItems.Pipings;
using MudBlazorWeb.Pages.BudgetItems.Structurals;
using MudBlazorWeb.Pages.BudgetItems.Taxs;
using MudBlazorWeb.Pages.BudgetItems.Testings;
...
public partial class BudgetItemsTable
{
    ...
    public List<BudgetItemResponse> Items => Response.Items;
    ...
    public Func<BudgetItemResponse, bool> Criteria => x =>
    ...
    public List<BudgetItemResponse> FilteredItems => string.IsNullOrEmpty(nameFilter) ? Items :
    ...
    public async Task Delete(BudgetItemResponse response)
    {
    ...
    HashSet<BudgetItemResponse> SelecteItems = null!;
