...
namespace Shared.Models.GanttTasks.Responses
{
    ...
    //    public DateTime StartDate => FlatOrderedItems.Count == 0 ? ProjectStartDate == null ? DateTime.Now : ProjectStartDate.Value : FlatOrderedItems.Where(x => x.StartDate.HasValue)
    //           .Select(x => x.StartDate!.Value)
    //           .DefaultIfEmpty(DateTime.MaxValue)
    //           .Min();
    //    public DateTime EndDate => FlatOrderedItems.Count == 0 ? ProjectStartDate == null ? DateTime.Now : ProjectStartDate.Value : FlatOrderedItems.Where(x => x.EndDate.HasValue)
    ...
    //    public void SetProjectTStartDate(DateTime? startDate)
    //    {
    //        FlatOrderedItems.ForEach(x => x.StartDate = startDate);
    //        Calculate();
    //    }
    ...
    //        }
    //    }
    //    public GanttTaskResponse AddGanttTaskResponse(Guid deliverableId, GanttTaskResponse? selectedRow, DateTime? ProjectStartDate)
    //    {
