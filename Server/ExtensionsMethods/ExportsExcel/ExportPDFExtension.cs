            ...
            container.Column(mainContentColumn =>
            {
                mainContentColumn.Item().Row(row =>
                {
                    ...
                    row.RelativeItem().AlignCenter().Column(column =>
                    {
                        ...
                        column
                            .Item().AlignCenter().PaddingBottom(0.5f, QuestPDF.Infrastructure.Unit.Centimetre).Text("Cali, Colombia.")
                ...
                mainContentColumn.Item().PaddingTop(0.8f, QuestPDF.Infrastructure.Unit.Centimetre).Row(row =>
                {
