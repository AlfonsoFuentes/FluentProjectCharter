...
using Server.DatabaseImplementations.Identity;
using Server.DatabaseImplementations.Storage;
using Server.DatabaseImplementations.UsersService;
...
using System.Text;
namespace Server.RegisterServices
{
