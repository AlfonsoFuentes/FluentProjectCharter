...
{
    public static class ChangeCommunicationOrderDownEndPoint
    {
        public class EndPoint : IEndPoint
        {
            public void MapEndPoint(IEndpointRouteBuilder app)
            {
                app.MapPost(StaticClass.Communications.EndPoint.UpdateDown, async (ChangeCommunicationOrderDowmRequest Data, IRepository Repository) =>
                {
                    ...
                    Expression<Func<Communication, bool>> Criteria = x => x.Id == Data.Id;
            ...
            private string[] GetCacheKeys(Communication row, Guid ProjectId)
            {
