...
{
    public static class ChangeBackGroundOrderDownEndPoint
    {
        public class EndPoint : IEndPoint
        {
            public void MapEndPoint(IEndpointRouteBuilder app)
            {
                app.MapPost(StaticClass.BackGrounds.EndPoint.UpdateDown, async (ChangeBackGroundOrderDowmRequest Data, IRepository Repository) =>
                {
                    ...
                    Expression<Func<BackGround, bool>> Criteria = x => x.Id == Data.Id;
            ...
            private string[] GetCacheKeys(BackGround row, Guid ProjectId)
            {
