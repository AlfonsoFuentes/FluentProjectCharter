...
{
    public static class ChangeQualityOrderUpEndPoint
    {
        public class EndPoint : IEndPoint
        {
            public void MapEndPoint(IEndpointRouteBuilder app)
            {
                app.MapPost(StaticClass.Qualitys.EndPoint.UpdateUp, async (ChangeQualityOrderUpRequest Data, IRepository Repository) =>
                {
                    ...
                    Expression<Func<Quality, bool>> Criteria = x => x.ProjectId == Data.ProjectId && x.Order == row.Order - 1;
