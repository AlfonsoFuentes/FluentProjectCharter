...
{
    public static class ChangeAssumptionOrderDownEndPoint
    {
        public class EndPoint : IEndPoint
        {
            public void MapEndPoint(IEndpointRouteBuilder app)
            {
                app.MapPost(StaticClass.Assumptions.EndPoint.UpdateDown, async (ChangeAssumptionOrderDowmRequest Data, IRepository Repository) =>
                {
                    ...
                    Expression<Func<Assumption, bool>> Criteria = x => x.Id == Data.Id;
            ...
            private string[] GetCacheKeys(Assumption row, Guid ProjectId)
            {
