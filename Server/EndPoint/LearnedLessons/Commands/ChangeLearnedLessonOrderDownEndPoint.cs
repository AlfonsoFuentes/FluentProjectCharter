...
{
    public static class ChangeLearnedLessonOrderDownEndPoint
    {
        public class EndPoint : IEndPoint
        {
            public void MapEndPoint(IEndpointRouteBuilder app)
            {
                app.MapPost(StaticClass.LearnedLessons.EndPoint.UpdateDown, async (ChangeLearnedLessonOrderDowmRequest Data, IRepository Repository) =>
                {
                    ...
                    Expression<Func<LearnedLesson, bool>> Criteria = x => x.Id == Data.Id;
