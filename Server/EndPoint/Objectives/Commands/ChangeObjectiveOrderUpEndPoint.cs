...
{
    public static class ChangeObjectiveOrderUpEndPoint
    {
        public class EndPoint : IEndPoint
        {
            public void MapEndPoint(IEndpointRouteBuilder app)
            {
                app.MapPost(StaticClass.Objectives.EndPoint.UpdateUp, async (ChangeObjectiveOrderUpRequest Data, IRepository Repository) =>
                {
                    ...
                    Expression<Func<Objective, bool>> Criteria = x => x.ProjectId == Data.ProjectId && x.Order == row.Order - 1;
