...
{
    public static class EditPurchaseOrderApprovedEndPoint
    {
        public class EndPoint : IEndPoint
        {
            public void MapEndPoint(IEndpointRouteBuilder app)
            {
                app.MapPost(StaticClass.PurchaseOrders.EndPoint.EditApproved, async (EditPurchaseApprovedOrderRequest Data, IRepository Repository) =>
                {
                    ...
                    List<string> cache = [.. StaticClass.PurchaseOrders.Cache.KeyEditApproved(row.Id, row.ProjectId)];
