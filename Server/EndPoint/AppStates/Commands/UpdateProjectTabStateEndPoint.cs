...
{
    public static partial class UpdateProjectTabStateEndPoint
    {
        public class EndPointProject : IEndPoint
        {
            public void MapEndPoint(IEndpointRouteBuilder app)
            {
                app.MapPost(StaticClass.AppStates.EndPoint.UpdateProjectTab, async (UpdateActiveStateRequest Data, IRepository Repository) =>
                {
                   ...
                   Data.ProjectId;
                    ...
                    project.ProjectTab = Data.ProjectTab;
