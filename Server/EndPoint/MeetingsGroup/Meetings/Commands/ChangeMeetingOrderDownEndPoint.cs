...
{
    public static class ChangeMeetingOrderDownEndPoint
    {
        public class EndPoint : IEndPoint
        {
            public void MapEndPoint(IEndpointRouteBuilder app)
            {
                app.MapPost(StaticClass.Meetings.EndPoint.UpdateDown, async (ChangeMeetingOrderDowmRequest Data, IRepository Repository) =>
                {
                    ...
                    Expression<Func<Meeting, bool>> Criteria = x => x.Id == Data.Id;
