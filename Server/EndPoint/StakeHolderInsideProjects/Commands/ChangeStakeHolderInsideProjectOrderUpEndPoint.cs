...
{
    //public static class ChangeStakeHolderInsideProjectOrderUpEndPoint
    //{
    //    public class EndPoint : IEndPoint
    //    {
    //        public void MapEndPoint(IEndpointRouteBuilder app)
    //        {
    //            app.MapPost(StaticClass.StakeHolderInsideProjects.EndPoint.UpdateUp, async (ChangeStakeHolderInsideProjectOrderUpRequest Data, IRepository Repository) =>
    //            {


    //                //var row = await Repository.GetByIdAsync<StakeHolderInsideProject>(Data.Id);

    //                //if (row == null) { return Result.Fail(Data.NotFound); }
    //                //if (row.Order == 1) { return Result.Success(Data.Succesfully); }

    //                //Expression<Func<StakeHolderInsideProject, bool>> Criteria = x => x.ProjectId == Data.ProjectId && x.Order == row.Order - 1;
    ...
    //            });
    //        }
    //        //private string[] GetCacheKeys(StakeHolderInsideProject row)
    //        //{
