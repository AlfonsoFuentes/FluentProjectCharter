...
namespace Server.Migrations
{
    ...
    [Migration("20241130002608_AddCompletePlanning")]
    partial class AddCompletePlanning
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Database.Entities.Bennefit", b =>
                {
                    ...
                    b.Property<Guid?>("OwnerOfBenefitId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("TermToGetBenefit")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Server.Database.Entities.Case", b =>
                {
                    ...
                    b.Property<string>("SituationAnalisis")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Server.Database.Entities.Risk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Database.Entities.Strategy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Database.Entities.Assumption", b =>
                {
                    b.HasOne("Server.Database.Entities.Bennefit", "Bennefit")
                        .WithMany("Assumptions")
                        .HasForeignKey("BennefitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Bennefit");
                });
            ...
            modelBuilder.Entity("Server.Database.Entities.Bennefit", b =>
                {
                    ...
                    b.HasOne("Server.Database.Entities.StakeHolder", "OwnerOfBenefit")
                        .WithMany("Bennefits")
                        .HasForeignKey("OwnerOfBenefitId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Server.Database.Entities.Strategy", "Strategy")
                        .WithMany("Bennefits")
