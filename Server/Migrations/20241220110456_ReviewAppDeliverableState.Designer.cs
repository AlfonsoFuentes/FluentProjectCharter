...
namespace Server.Migrations
{
    ...
    [Migration("20241220110456_ReviewAppDeliverableState")]
    partial class ReviewAppDeliverableState
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Database.Entities.AppState", b =>
                {
                    ...
                    b.Property<Guid>("ActiveDeliverableState")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ActiveProjectId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CaseAcordionActive")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CaseTabActive")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ProjectAcordionActive")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ProjectTabActive")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ScopeAcordionActive")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Database.Entities.AppStateDeliverable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("AppStateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("DeliverableAcordionActive")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("DeliverableTabActive")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppStateDeliverables");
                });
            ...
            modelBuilder.Entity("Server.Database.Entities.AppStateDeliverable", b =>
                {
                    b.HasOne("Server.Database.Entities.AppState", "AppState")
                        .WithMany("AppStateDeliverables")
            ...
            modelBuilder.Entity("Server.Database.Entities.AppState", b =>
                {
                    b.Navigation("AppStateDeliverables");
                });
