...
namespace Server.Migrations
{
    ...
    [Migration("20250212000527_RelateBudgetItemToDeliverable")]
    partial class RelateBudgetItemToDeliverable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItemValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Database.Entities.Deliverable", b =>
                {
                    b.HasOne("Server.Database.Entities.Deliverable", "Dependant")
                        .WithMany("Dependants")
                        .HasForeignKey("DependentantId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Server.Database.Entities.Deliverable", "ParentDeliverable")
            ...
            modelBuilder.Entity("Server.Database.Entities.Milestone", b =>
                {
                    b.HasOne("Server.Database.Entities.Milestone", "Dependant")
                        .WithMany("Dependants")
                        .HasForeignKey("DependentantId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Server.Database.Entities.Milestone", "ParentMilestone")
